...
const ACHIEVEMENT_DEFINITIONS = {
  'named-city':            { label: 'Named your city',                  quip: "It has a name now. It's real." ,                          cat: 'City'        },
  'completed-all':         { label: 'Completed all five districts',      quip: 'Your city is whole. Every district, every memory.',        cat: 'City'        },
  'shared-city':           { label: 'Shared your city',                  quip: 'You let someone else in.',                                cat: 'City'        },

  'sent-first-train':      { label: 'Sent a Train Thought',               quip: 'A thought that almost slipped away. You caught it.',       cat: 'Train'       },
  'sent-5-trains':         { label: 'Sent 5 Train Thoughts',              quip: 'The train keeps coming back for you.',                     cat: 'Train'       },
  'sent-10-trains':        { label: 'Sent 10 Train Thoughts',             quip: 'Some people are full of passing thoughts. You write yours down.', cat: 'Train'       },
  'train-to-all':          { label: 'Sent a thought to every district',   quip: 'Every part of your city has heard from you.',              cat: 'Train'       },
  'began-garden':          { label: 'Entered the Garden',                quip: 'Something is beginning to grow.',                         cat: 'Exploration'  },
  'completed-garden':      { label: 'Completed the Garden',              quip: 'The Garden is yours now.',                                cat: 'Completion'   },
  'returned-garden':       { label: 'Returned to the Garden',            quip: 'Growth does that.',                                       cat: 'Exploration'  },
  'named-garden':          { label: 'Named the Garden',                  quip: 'A place worth keeping deserves a name.',                  cat: 'Naming'       },
  'began-shrine':          { label: 'Entered the Shrine',                quip: 'You remembered something sacred.',                        cat: 'Exploration'  },
  'completed-shrine':      { label: 'Completed the Shrine',              quip: 'You held it long enough to put it into words.',           cat: 'Completion'   },
  'returned-shrine':       { label: 'Returned to the Shrine',            quip: 'Some places ask to be revisited.',                        cat: 'Exploration'  },
  'named-shrine':          { label: 'Named the Shrine',                  quip: 'Reverence has an address now.',                           cat: 'Naming'       },
  'began-cornerstore':     { label: 'Entered the Cornerstore',           quip: 'You know this kind of place.',                            cat: 'Exploration'  },
  'completed-cornerstore': { label: 'Completed the Cornerstore',         quip: 'Routine, preserved.',                                     cat: 'Completion'   },
  'returned-cornerstore':  { label: 'Returned to the Cornerstore',       quip: 'Habit brought you back.',                                 cat: 'Exploration'  },
  'named-cornerstore':     { label: 'Named the Cornerstore',             quip: 'Even ordinary places deserve a name.',                   cat: 'Naming'       },
  'began-tower':           { label: 'Entered the Tower',                 quip: 'Alone, but you climbed anyway.',                          cat: 'Exploration'  },
  'completed-tower':       { label: 'Completed the Tower',               quip: 'You sat with solitude and wrote it down.',                cat: 'Completion'   },
  'returned-tower':        { label: 'Returned to the Tower',             quip: 'Solitude keeps calling you back.',                        cat: 'Exploration'  },
  'named-tower':           { label: 'Named the Tower',                   quip: 'Your solitude has a postcode.',                           cat: 'Naming'       },
  'began-plaza':           { label: 'Entered the Plaza',                 quip: 'You were part of something bigger.',                      cat: 'Exploration'  },
  'completed-plaza':       { label: 'Completed the Plaza',               quip: 'Community, remembered.',                                  cat: 'Completion'   },
  'returned-plaza':        { label: 'Returned to the Plaza',             quip: 'You keep coming back to the people.',                     cat: 'Exploration'  },
  'named-plaza':           { label: 'Named the Plaza',                   quip: 'The place where you belonged has a name.',                cat: 'Naming'       },
};
...
function unlockAchievement(id, silent = false) {
  ...
  const onDistrictOrCustomizePage = window.location.pathname.indexOf('/districts/') !== -1;
  if (!silent && !onDistrictOrCustomizePage) showToast(entry);
