...
let photoSortOrder   = 'latest';
let songSortOrder    = 'latest';
...
function confirmDeleteEntry(ts) {
  ...
  overlay.style.cssText = 'position:fixed;top:0;left:0;width:100vw;height:100vh;background:rgba(12,33,119,0.15);display:flex;align-items:center;justify-content:center;z-index:1000;';
  overlay.innerHTML = `
...
// media (sidebar photo + music, legacy)
...
function openAddSongOverlay() {
  ...
  overlay.style.cssText = [
    ...
    'background:rgba(12,33,119,0.15)','display:flex','align-items:center',
