// rita-notes.js
// RETIRED: this was a user-testing feedback tool (capstone testing phase).
// do not add a <script src="js/rita-notes.js"> tag to any page —
// it is intentionally left out of every page now that testing is done.
